...
class Ids
{
    protected:
        ...
        void setArray(blitz::Array<double,7>&array,double *arrayPtr, int dim1, int dim2, int dim3, int dim4, int dim5, int dim6, 
		int dim7)
        {
            blitz::Array<double,7> newArray(arrayPtr, shape(dim1, dim2, dim3, dim4, dim5, dim6,dim7), duplicateData, fortranArray);
            array.resize(newArray.shape());
            array = newArray;
        }
