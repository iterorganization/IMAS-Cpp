...
{
	Array<float,1> newArray(arrayPtr, shape(dim1));
	array.resize(newArray.shape());
	array = newArray;
}
...
{
	Array<float,2> newArray(arrayPtr, shape(dim1, dim2));
	array.resize(newArray.shape());
	array = newArray;
}
...
{
	Array<float,3> newArray(arrayPtr, shape(dim1, dim2, dim3));
	array.resize(newArray.shape());
	array = newArray;
}
...
{
	Array<float,4> newArray(arrayPtr, shape(dim1, dim2, dim3, dim4));
	array.resize(newArray.shape());
	array = newArray;
}
...
{
	Array<float,5> newArray(arrayPtr, shape(dim1, dim2, dim3, dim4, dim5));
	array.resize(newArray.shape());
	array = newArray;
}
...
{
	Array<float,6> newArray(arrayPtr, shape(dim1, dim2, dim3, dim4, dim5, dim6));
	array.resize(newArray.shape());
	array = newArray;
}
...
int dim7)
{
	Array<double,7> newArray(arrayPtr, shape(dim1, dim2, dim3, dim4, dim5, dim6,dim7));
	array.resize(newArray.shape());
	array = newArray;
}
